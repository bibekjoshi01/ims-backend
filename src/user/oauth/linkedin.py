...
class LinkedInOAuth(OAuthProvider):
    """
    LinkedIn OAuth provider class for validating authentication tokens
    ...
    def validate(cls, auth_token: str = None) -> UserInfo | Dict:
        ...
        linkedin_settings = cls._get_provider_settings("linkedin")
        ...
        try:
            ...
            raise ValueError(f"Failed to fetch user information from LinkedIn API: {err}")
